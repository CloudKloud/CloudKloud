...
해당  [주소](https://github.com/CloudKloud/CloudKloud)로 가면 code를 확인할 수 있고, 

해당  [주소](https://cloudkloud.github.io/CloudKloud/jekyll/minimal-mistakes/Setting/)로 가면 서비스를 활용하기 위해 설정하는 절차를 안내 해줍니다.
